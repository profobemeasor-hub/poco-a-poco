...
echo "Poco a Poco v13 — Partner & Tutor Mode"
echo "Target: $TARGET"
...
echo "4/5 Committing..."
git add -A
if git diff --cached --quiet; then echo "No code changes to commit."; else git commit -m "Poco a Poco v13 - Partner and Tutor Mode"; fi
echo "5/5 Publishing..."
git push
echo ""
echo "✓ v13 published."
echo "No paid API or backend is required."
