...
echo "Poco a Poco v8 — Adaptive Offline Coach"
echo "Target: $TARGET"
...
echo "2/5 Installing clean pinned dependencies..."
...
if git diff --cached --quiet; then
  ...
  git commit -m "Poco a Poco v8 - Adaptive Offline Coach"
fi
...
echo ""
echo "✓ v8 published."
echo "No OpenAI API or Cloudflare Worker is required."
